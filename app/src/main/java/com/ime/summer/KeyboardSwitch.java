...
public class KeyboardSwitch {
  ...
  public void initializeKeyboard(int displayWidth) {
    ...
    if ( chineseKeyboardId == R.xml.summer ) {
    	englishKeyboard = new SoftKeyboard(context, R.xml.qwerty_for_summer_en);
    } else {
  ...
  public boolean onKey(int keyCode) {
    switch (keyCode) {
      ...
      case Keyboard.KEYCODE_SHIFT:
        ...
        if (currentKeyboard.isSummer()) {
          // do nothing, the function of shift button is undefined.
          return true;
        }
    }
